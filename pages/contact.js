  ...
  return (
    <>
      <div className="container mx-auto px-6">
        <div className="mb-8 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 bg-gray-100 text-gray-900 rounded-lg shadow-lg">
      ...
      <section className="bg-[antiquewhite] dark:bg-gray-900 mb-6">
...
export default WithLayout(Contact, {title: "Contactus"});